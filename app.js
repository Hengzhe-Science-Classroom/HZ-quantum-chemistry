// === Quantum Chemistry - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('quantum-chemistry-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('quantum-chemistry-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
